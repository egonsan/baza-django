...
from equipment.views_auth import login_view, oprogramowanie_view, logout_view
...
urlpatterns = [
    ...
    # Główna zakładka po zalogowaniu
    path("baza/oprogramowanie/", oprogramowanie_view, name="oprogramowanie"),

    # Aplikacja equipment (sprzęt, magazyn, pomieszczenia, pracownicy)
